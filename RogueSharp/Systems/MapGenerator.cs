...
namespace RogueSharp.Systems
{
    public class MapGenerator
    {
        ...
        // Constructing a MapGenerator requires the dimensions of the maps it will create
        ...
        // Create a new map that is a simple open floor with surrounding walls
